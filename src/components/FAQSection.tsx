...
const faqs = [
  {
    ...
    answer: "Мы работаем по системе постоплаты: вы оплачиваете работу только после проверки и одобрения. Для крупных заказов возможна оплата частями. Принимаем карты, ЮMoney, СБП.",
  },
  {
